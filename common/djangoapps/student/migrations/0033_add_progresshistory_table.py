...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProgressHistory'
        db.create_table('student_progresshistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('course_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('subsection_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('units_chain', self.gf('django.db.models.fields.TextField')(default='[]')),
        ))
        db.send_create_signal('student', ['ProgressHistory'])


    def backwards(self, orm):
        # Deleting model 'ProgressHistory'
        db.delete_table('student_progresshistory')
    ...
    models = {
        ...
        'student.progresshistory': {
            'Meta': {'object_name': 'ProgressHistory'},
            'course_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subsection_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'units_chain': ('django.db.models.fields.TextField', [], {'default': "'[]'"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },

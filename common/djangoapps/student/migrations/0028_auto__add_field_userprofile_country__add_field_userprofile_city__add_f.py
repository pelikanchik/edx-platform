...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_userprofile', 'country',
                      self.gf('django.db.models.fields.CharField')(default='RU', max_length=255, db_index=True, blank=True),
                      keep_default=False)
        ...
        db.add_column('auth_userprofile', 'middle_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.company_name'
        db.add_column('auth_userprofile', 'company_name',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.position'
        db.add_column('auth_userprofile', 'position',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'TestCenterUser.first_name'
        db.alter_column('student_testcenteruser', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'TestCenterUser.middle_name'
        db.alter_column('student_testcenteruser', 'middle_name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('auth_userprofile', 'middle_name')

        # Deleting field 'UserProfile.company_name'
        db.delete_column('auth_userprofile', 'company_name')

        # Deleting field 'UserProfile.position'
        db.delete_column('auth_userprofile', 'position')


        # Changing field 'TestCenterUser.first_name'
        db.alter_column('student_testcenteruser', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'TestCenterUser.middle_name'
        db.alter_column('student_testcenteruser', 'middle_name', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'company_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "'RU'", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
            'courseware': ('django.db.models.fields.CharField', [], {'default': "'course.xml'", 'max_length': '255', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            'gender': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'goals': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            'level_of_education': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'mailing_address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'meta': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'middle_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),
            'position': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'blank': 'True'}),

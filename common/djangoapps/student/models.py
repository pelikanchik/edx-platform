...
class UserProfile(models.Model):
    ...
    country = models.CharField(blank=True, max_length=255, db_index=True, choices=COUNTRIES, default = "RU")
    city = models.CharField(blank=True, max_length=255, db_index=True)
    first_name = models.CharField(blank=True, max_length=50, db_index=True)
    last_name = models.CharField(blank=True, max_length=50, db_index=True)
    middle_name = models.CharField(blank=True, max_length=50, db_index=True)
    COMPANY_NAMES = (
        ('as', u'ASBIS'),
        ('ot', u'Other')
    )
    company_name = models.CharField(max_length=255, blank=True, choices=COMPANY_NAMES, db_index=True)
    POSITION_NAMES = (
        ('FA', u'Accountant'),
        ('ACM', u'Administrative Director'),
        ('GM', u'General Manager'),
        ('TDM', u'Training & Development Manager'),
        ('PM', u'Product Development Projects Manager'),
        ('PDD', u'Products Development Director'),
        ('SDD', u'Solutions Development Director'),
        ('SDE', u'Solutions Development Engineer'),
        ('FD', u'Finance Director'),
        ('FM', u'Finance Manager'),
        ('RFD', u'Regional Finance Director'),
        ('ERP specialist', u'ERP specialist'),
        ('LIM', u'Imports Manager'),
        ('LIS', u'Internal Sales Manager'),
        ('LA', u'Logistics Administrator'),
        ('LA', u'Logistics Assistant'),
        ('LD', u'Logistics Director'),
        ('LM', u'Logistics Manager'),
        ('LS', u'Logistics Specialist'),
        ('LSU', u'Logistics Supervisor'),
        ('LTL', u'Logistics Team leader'),
        ('SCM', u'Supply Chain Manager'),
        ('CEO', u'Chief Executive Officer'),
        ('CFO', u'Chief Finance Officer'),
        ('CLO', u'Chief Learning Officer'),
        ('COO', u'Chief Operational Officer'),
        ('EVPSM', u'Executive VP Sales & Marketing'),
        ('GMSD', u'General and Commercial director'),
        ('IRM', u'Investor Relations Manager'),
        ('PSD', u'Project Support Director'),
        ('RSD', u'Regional Sales Director'),
        ('RVP', u'Regional Vice President'),
        ('VPLS', u'Vice President Logistics & Customer Services'),
        ('CMM', u'Category Marketing Manager'),
        ('CMO', u'Chief Marketing Officer'),
        ('MD', u'Marketing Director'),
        ('MM', u'Marketing Manager'),
        ('PM', u'Product Manager'),
        ('PMD', u'Product Managers Director'),
        ('PME', u'Product Marketing Engineer'),
        ('PJM', u'Projects Manager'),
        ('VPPL', u'VP Private Labels'),
        ('BDM', u'Business Development Manager'),
        ('PLMTL', u'PLM team leader'),
        ('PLM', u'Product Line Manager'),
        ('MPMM', u'Product Marketing Manager'),
        ('PURM', u'Purchase Manager'),
        ('PUR', u'Purchaser'),
        ('SCMM', u'Supply Chain Management Manager'),
        ('PSOA', u'Supply Operational Administrator'),
        ('VPPM', u'Vice President Product Marketing'),
        ('SMR', u'Manager Sales to Retail'),
        ('OMR', u'Operational Manager to Retail'),
        ('RC', u'Retail Co-ordinator'),
        ('RSM', u'Retail Sales Manager'),
        ('STLR', u'Retail Sales Team Leader'),
        ('BM', u'Branch Manager'),
        ('BDD', u'Business Development Director'),
        ('KAM', u'Key Accounts Manager'),
        ('PLSM', u'Product Line Sales Manager'),
        ('SA', u'Sales Assistant'),
        ('SDM', u'Sales Development Manager'),
        ('SD', u'Sales Director'),
        ('SM', u'Sales Manager'),
        ('SMI', u'Sales Manager International'),

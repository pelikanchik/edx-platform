...
class TestItemCrud(SplitModuleTest):
    ...
    def test_encoded_naming(self):
        ...
        """
        parent_locator = BlockUsageLocator(course_id="contender", block_id="head345679", branch='draft')
        chapter_locator = BlockUsageLocator(course_id="contender", block_id="foo.bar_-~:0", branch='draft')
        ...
        new_payload = "<problem>empty</problem>"
        problem_locator = BlockUsageLocator(course_id="contender", block_id="prob.bar_-~:99a", branch='draft')
        modulestore().create_item(

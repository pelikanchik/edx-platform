...
function toggleSections(e) {
    ...
    $button = $(this);
    $labelCollapsed = $('<i class="icon-arrow-up"></i> <span class="label">Свернуть все разделы</span>');
    $labelExpanded = $('<i class="icon-arrow-down"></i> <span class="label">Развернуть все разделы</span>');

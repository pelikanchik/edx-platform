...
CMS.Views.Settings.Advanced = CMS.Views.ValidatingView.extend({
    ...
    showNotificationBar: function(self) {
        ...
        var confirm = new CMS.Views.Notification.Warning({
            ...
            actions: {
                ...
                secondary: [{
                    ...
                    "class": "action-cancel",
                    "click": function() {
                        self.revertView(self);
                        confirm.hide();
                        self.notificationBarShowing = false;
                    }
                }],
            }});
        self.notificationBarShowing = true;
        confirm.show();
    },
    saveView : function(self) {

...
//                var node_size = edges_arr[node_number].length + 1;
                ...
                //var node_popup = r.popup(node_box.x + node_box.width, node_box.y, $.grep(names_obj, function(e){ return e.locator == node.id })[0]["name"]);
...
//                ellipse.node.ondblclick = show_details;
                ...
                var shape = r.set().
                    ...
                    push(vertex_text);
                    //push(node_popup);
                shape.name_popup = r.popup(node_box.x + node_box.width, node_box.y, $.grep(names_obj, function(e){ return e.locator == node.id })[0]["name"]);

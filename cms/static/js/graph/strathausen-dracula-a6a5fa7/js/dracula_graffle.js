...
//                {x: bb2.x + bb2.width + off2, y: bb2.y + bb2.height / 2}  /* EAST  2 */
            ...
            {x: bb1.x + bb1.width / 2 + gap_x, y: bb1.y},              /* NORTH 1 */
            {x: bb1.x + bb1.width / 2 - gap_x, y: bb1.y + bb1.height}, /* SOUTH 1 */
            {x: bb1.x, y: bb1.y + bb1.height / 2 - gap_y },             /* WEST  1 */
            {x: bb1.x + bb1.width, y: bb1.y + bb1.height / 2 + gap_y}, /* EAST  1 */

            {x: bb2.x + bb2.width / 2 - gap_x, y: bb2.y},              /* NORTH 2 */
            {x: bb2.x + bb2.width / 2 + gap_x, y: bb2.y + bb2.height + off2}, /* SOUTH 2 */
            {x: bb2.x, y: bb2.y + bb2.height / 2 + gap_y},             /* WEST  2 */
            {x: bb2.x + bb2.width , y: bb2.y + bb2.height / 2 - gap_y}  /* EAST  2 */
        ];
